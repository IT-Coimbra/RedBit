...
# Training settings
parser = argparse.ArgumentParser(description='DoReFa-Net PyTorch implementation (MNIST dataset)')
...
parser.add_argument('-wb', '--wbits', type=int, default=32,
					help='Bit width to represent weights')
parser.add_argument('-ab', '--abits', type=int, default=32,
...
if __name__ == '__main__':
	...
	args.networkCfg = f'MNIST.LeNet-5.DoReFa-Net.W{args.wbits}.A{args.abits}.G32.{args.optimizer}.LR{args.learning_rate}'
