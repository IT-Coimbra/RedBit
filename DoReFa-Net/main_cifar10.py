...
# Training settings
parser = argparse.ArgumentParser(description='DoReFa-Net PyTorch implementation (CIFAR-10 dataset)')
...
if __name__ == '__main__':
	...
	args.networkCfg = f'CIFAR-10.{args.network}-{args.layers}{bn}.DoReFa-Net.W{args.wbits}.A{args.abits}.G32.{args.optimizer}.LR{args.learning_rate}'
