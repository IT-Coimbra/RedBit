...
# Training settings
parser = argparse.ArgumentParser(description='QNN PyTorch implementation (ImageNet dataset)')
...
if __name__ == '__main__':
	...
	if args.network.lower() in ('resnet', 'vgg'):
		args.networkCfg = f'ImageNet.{args.network}-{args.layers}{bn}.QNN.W{args.wbits}.A{args.abits}.G32.{args.optimizer}.LR{args.learning_rate}'
	elif args.network.lower() == 'alexnet':
		args.networkCfg = f'ImageNet.{args.network}.QNN.W{args.wbits}.A{args.abits}.G32.{args.optimizer}.LR{args.learning_rate}'
