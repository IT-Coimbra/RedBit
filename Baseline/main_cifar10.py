...
# Training settings
parser = argparse.ArgumentParser(description='Baseline PyTorch implementation (CIFAR-10 dataset)')
...
parser.add_argument('-wd', '--weight_dacay', type=float, default=1e-4,
...
if __name__ == '__main__':
	...
	args.networkCfg = f'CIFAR-10.{args.network}-{args.layers}{bn}.Baseline.W32.A32.G32.{args.optimizer}.LR{args.learning_rate}'
